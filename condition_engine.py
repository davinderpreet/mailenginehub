...
TEMPLATE_FAMILIES = {
    "welcome": {
        ...
        "allowed_blocks": ["hero", "text", "discount", "product_grid", "product_hero", "trust_reassurance", "features_benefits", "urgency", "cta", "divider",
                           "driver_testimonial", "best_seller_proof", "feature_highlights", "bundle_value", "why_choose_this",
                           "stat_callout", "whats_included", "faq", "brand_story"],
        "recommended_order": ["hero", "text", "discount", "trust_reassurance", "product_grid", "urgency", "cta"],
    ...
    "browse_recovery": {
        ...
        "allowed_blocks": ["hero", "text", "product_grid", "product_hero", "comparison_block", "trust_reassurance", "features_benefits", "cta", "urgency", "divider",
    ...
    "cart_recovery": {
        ...
        "allowed_blocks": ["hero", "text", "product_grid", "product_hero", "discount", "trust_reassurance", "features_benefits", "cta", "urgency", "divider",
                           "objection_handling", "why_choose_this", "bundle_value",
                           "faq", "whats_included"],
        "recommended_order": ["hero", "text", "product_grid", "discount", "trust_reassurance", "urgency", "cta"],
        "required_blocks": ["cta"],
        "max_blocks": 12,
    },
    "checkout_recovery": {
        ...
        "allowed_blocks": ["hero", "text", "product_grid", "product_hero", "discount", "trust_reassurance", "features_benefits", "cta", "urgency", "divider",
                           "objection_handling", "feature_highlights",
                           "faq", "stat_callout"],
        "recommended_order": ["hero", "text", "product_grid", "objection_handling", "trust_reassurance", "cta"],
        "required_blocks": ["cta"],
        "max_blocks": 10,
    },
    "post_purchase": {
        ...
        "allowed_blocks": ["hero", "text", "product_grid", "product_hero", "comparison_block", "discount", "trust_reassurance", "features_benefits", "cta", "divider",
                           "driver_testimonial", "comparison", "bundle_value",
                           "whats_included", "faq", "brand_story"],
        "recommended_order": ["hero", "text", "product_hero", "product_grid", "cta"],
    ...
    "winback": {
        ...
        "allowed_blocks": ["hero", "text", "discount", "product_grid", "product_hero", "comparison_block", "trust_reassurance", "features_benefits", "cta", "urgency", "divider",
                           "driver_testimonial", "comparison", "objection_handling", "best_seller_proof", "feature_highlights",
                           "competitor_comparison", "spec_table", "stat_callout", "faq", "use_case_match", "brand_story"],
        "recommended_order": ["hero", "text", "discount", "product_hero", "product_grid", "trust_reassurance", "urgency", "cta"],
        "required_blocks": ["text", "cta"],
        "max_blocks": 12,
    },
    "high_intent_browse": {
        "label": "High-Intent Browse",
        "description": "Emails for contacts who viewed products multiple times or spent significant time browsing",
        "allowed_blocks": ["hero", "text", "product_grid", "product_hero", "discount", "trust_reassurance", "features_benefits", "cta", "urgency", "divider",
                           "driver_testimonial", "comparison", "why_choose_this", "objection_handling", "best_seller_proof", "feature_highlights", "bundle_value",
                           "competitor_comparison", "spec_table", "stat_callout", "whats_included", "faq", "use_case_match", "brand_story"],
        "recommended_order": ["hero", "product_hero", "why_choose_this", "driver_testimonial", "comparison", "cta"],
        "required_blocks": ["cta"],
        "max_blocks": 12,
    },
    "promo": {
        ...
        "allowed_blocks": ["hero", "text", "discount", "product_grid", "product_hero", "comparison_block", "trust_reassurance", "features_benefits", "cta", "urgency", "divider",
                           "driver_testimonial", "comparison", "why_choose_this", "objection_handling", "bundle_value", "best_seller_proof", "feature_highlights",
                           "competitor_comparison", "spec_table", "stat_callout", "whats_included", "faq", "use_case_match", "brand_story"],
        "recommended_order": ["hero", "discount", "product_grid", "trust_reassurance", "urgency", "cta"],
        "required_blocks": ["cta"],
        "max_blocks": 14,
    },
}
