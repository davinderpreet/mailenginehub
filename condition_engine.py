...
TEMPLATE_FAMILIES = {
    ...
    "post_purchase": {
        ...
        "allowed_blocks": ["hero", "text", "product_grid", "product_hero", "comparison_block", "discount", "trust_reassurance", "features_benefits", "feature_highlights", "cta", "divider",
