...
> 57 files, 35,522 lines. For full detail: read `REFERENCE.md`
...
| File | Lines | Role |
|------|-------|------|
| `app.py` | 7,408 | Flask application — all routes, scheduler, webhooks, auth |
| `block_registry.py` | 2,476 | Email template block rendering engine — 26 block types, validation, personalization |
| `database.py` | 1,887 | All 53 Peewee ORM models + init_db() + migration helpers |
