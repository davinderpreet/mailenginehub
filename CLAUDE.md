...
> 63 files, 41,974 lines. For full detail: read `REFERENCE.md`
...
| `am_runtime.py` | 1,116 | AM decision engine — structured action ranking, product/offer selection, template_engine rendering (Phase 4) |
