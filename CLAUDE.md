...
> 63 files, 41,673 lines. For full detail: read `REFERENCE.md`
...
| File | Lines | Role |
|------|-------|------|
| `app.py` | 7,347 | Flask application — all routes, scheduler, webhooks, auth |
...
| `account_manager.py` | 1,650 | Account Manager AI — autonomous nightly email campaign planning and execution via Claude |
...
| `customer_intelligence.py` | 1,314 | Nightly enrichment — lifecycle stage, customer type, intent, churn risk, send window, LTV |
...
| `am_runtime.py` | 1,035 | AM decision engine — structured action ranking, product/offer selection, template_engine rendering (Phase 4) |
