...
> 57 files, 34,812 lines. For full detail: read `REFERENCE.md`
...
| `profit_engine.py` | 866 | Product profitability scoring — Shopify cost/inventory sync, margin computation, promo eligibility |
