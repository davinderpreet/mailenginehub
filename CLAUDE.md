...
> 63 files, 41,841 lines. For full detail: read `REFERENCE.md`
...
| `am_runtime.py` | 1,059 | AM decision engine — structured action ranking, product/offer selection, template_engine rendering (Phase 4) |
