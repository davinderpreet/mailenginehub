...
> 63 files, 41,854 lines. For full detail: read `REFERENCE.md`
...
| `account_manager.py` | 1,657 | Account Manager AI — autonomous nightly email campaign planning and execution via Claude |
