...
> 63 files, 42,471 lines. For full detail: read `REFERENCE.md`
...
| `am_runtime.py` | 1,519 | AM decision engine — structured action ranking, product/offer selection, template_engine rendering (Phase 4) |
