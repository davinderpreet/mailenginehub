...
> 62 files, 39,404 lines. For full detail: read `REFERENCE.md`
...
| File | Lines | Role |
|------|-------|------|
| `app.py` | 7,411 | Flask application — all routes, scheduler, webhooks, auth |
...
| `generate-context.py` | 1,336 | Auto-generates CLAUDE.md, REFERENCE.md, MEMORY.md by scanning codebase (this file) |
