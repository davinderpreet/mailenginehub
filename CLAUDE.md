...
> 63 files, 40,406 lines. For full detail: read `REFERENCE.md`
...
| `account_manager.py` | 1,762 | Account Manager AI — autonomous nightly email campaign planning and execution via Claude |
...
| `am_runtime.py` | 886 | AM decision engine — structured action ranking, product/offer selection, template_engine rendering (Phase 4) |
