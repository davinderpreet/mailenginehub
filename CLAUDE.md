...
> 63 files, 41,989 lines. For full detail: read `REFERENCE.md`
...
| `account_manager.py` | 1,727 | Account Manager AI — autonomous nightly email campaign planning and execution via Claude |
