...
> 62 files, 39,396 lines. For full detail: read `REFERENCE.md`
...
| `database.py` | 1,967 | All 53 Peewee ORM models + init_db() + migration helpers |
| `account_manager.py` | 1,693 | Account Manager AI — autonomous nightly email campaign planning and execution via Claude |
| `generate-context.py` | 1,350 | Auto-generates CLAUDE.md, REFERENCE.md, MEMORY.md by scanning codebase (this file) |
...
| `flow_runtime.py` | 864 | Flow send package builder — centralizes flow render/decision logic (Phase 3) |
